...
Call CheeseHole ;
whitemattersurf1 = news;
Physical Surface (whitemattersurf1) = {l8+1,l5+1,l1+1,l2+1,l3+1,l7+1,l6+1,l4+1}; 
whitemattervolume1 = newreg;
Volume(whitemattervolume1) = {theloops[1]};
whitemattervol1 = newreg;
Physical Volume (whitemattervol1) = whitemattervolume1;

lcar3 = .085;
x = 0.; y= 0.; z=0.; r=7.0; t=2;
Call CheeseHole ;
whitemattersurf2 = news;
Physical Surface (whitemattersurf2) = {l8+1,l5+1,l1+1,l2+1,l3+1,l7+1,l6+1,l4+1}; 
whitemattervolume2 = newreg;
Volume(whitemattervolume2) = {theloops[2], theloops[1]};
whitemattervol2 = newreg;
Physical Volume (whitemattervol2) = whitemattervolume2;
